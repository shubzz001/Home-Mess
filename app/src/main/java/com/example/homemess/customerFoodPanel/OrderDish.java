...
import com.example.homemess.messFoodPanel.UpdateDishModel;
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        messdata.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                String loc = "<b>" + "Location: " + "</b>" + mess.getArea();
                        ...
                        dataref.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (MessID.equals(cart1.getMessId())) {
                                        data = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(City).child(Sub).child(MessID).child(RandomId);
                                    ...
                                    else
                                    {
                                        ...
                                        builder.setMessage("You can't add food items of multiple mess at a time. Try to add items of same mess");
