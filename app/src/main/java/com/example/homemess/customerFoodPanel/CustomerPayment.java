                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                            ...
                            hashMap.put("MessId", customerPaymentOrders.getMessId());
                        ...
                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                hashMap1.put("Status", "Your order is waiting to be prepared by Mess...");
                                        ...
                                        Reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                    ...
                                                    MessID = customerPaymentOrderss.getMessId();
                                                    hashMap2.put("MessId", customerPaymentOrderss.getMessId());
                                                ...
                                                dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                                                    ...
                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                        ...
                                                        hashMap3.put("Status", "Your order is waiting to be prepared by Mess...");
