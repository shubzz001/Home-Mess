                                                                                                ...
                                                                                                getRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        for (DataSnapshot dataSnapshot2 : dataSnapshot.getChildren()) {
                                                                                                            ...
                                                                                                            String userid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                                                                                                            MessId = customerPendingOrders.getMessId();
                                                                                                                            ...
                                                                                                                            public void onSuccess(Void aVoid) {
                                                                                                                                ...
                                                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(MessId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                                    ...
                                                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                        ...
                                                                                                                                        ReusableCodeForAll.ShowAlert(getContext(), "", "Your Order has been shifted to Pending state, please wait until the Mess accept your order.");
                                                                                                                                    }
