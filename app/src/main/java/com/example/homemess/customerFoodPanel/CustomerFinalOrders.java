...
public class CustomerFinalOrders {
    ...
    public CustomerFinalOrders(String messId, String dishId, String dishName, String dishPrice, String dishQuantity, String randomUID, String totalPrice, String userId) {
        MessId = messId;
        DishId = dishId;
        DishName = dishName;
        DishPrice = dishPrice;
