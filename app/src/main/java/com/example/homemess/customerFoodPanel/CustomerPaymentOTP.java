                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                            ...
                            hashMap.put("ChefId", customerPaymentOrders.getMessId());
                                        ...
                                        Reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                    ...
                                                    ChefID = customerPaymentOrderss.getMessId();
                                                    hashMap2.put("ChefId", customerPaymentOrderss.getMessId());
                                                                                            ...
                                                                                            public void onSuccess(Void aVoid) {
                                                                                                ...
                                                                                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                                                    ...
                                                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                                                        ...
                                                                                                        dialog.dismiss();
                                                                                                        Intent b = new Intent(CustomerPaymentOTP.this, CustomerFoofPanel_BottomNavigation.class);
