    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(statee.equals("Maharashtra")){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(MessRegistration.this,android.R.layout.simple_spinner_item,list);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(MessRegistration.this);
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    ...
                                                                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                        ...
                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                            ...
                                                                            Intent b = new Intent(MessRegistration.this, MessVerifyPhone.class);
                                                                    ...
                                                                    mDialog.dismiss();
                                                                    ReusableCodeForAll.ShowAlert(MessRegistration.this,"Error",task.getException().getMessage());
                                                                }
                                                            }
                                                        });
...
//
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(MessRegistration.this,Messlogin.class));
                finish();
            }
        });
        Phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MessRegistration.this,Messloginphone.class));
                finish();
            }
        });
    }
